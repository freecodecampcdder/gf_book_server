...
// LanguageDao is the data access object for table language.
...
// LanguageColumns defines and stores column names for table language.
...
// languageColumns holds the columns for table language.
